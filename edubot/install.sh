...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=SYRobot
EXTENSION_ID=edubot
COLLABORATOR=SYRobot
EXTENSION_DESCRIPTION="SYRobot Scratch Extension"
...
cp ${EXTENSION_ID}/scratch-gui/src/lib/libraries/extensions/${EXTENSION_ID}/${EXTENSION_ID}-small.svg src/lib/libraries/extensions/${EXTENSION_ID}/
